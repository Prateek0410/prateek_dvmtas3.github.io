...
videooooo.addEventListener('mouseleave', () => {
  ...
  const btn7 = document.getElementById('arrow-left-mobile');
  const btn8 = document.getElementById('arrow-right-mobile');
  const btn9 = document.getElementById('arrow-left-mobile-duplicate');
  const btn10 = document.getElementById('arrow-right-mobile-duplicate');
  btn3.onclick =()=>{
